  ...
  public: {
    Tables: {
      ...
      corporate_participants: {
        ...
        Relationships: [
          {
            foreignKeyName: "corporate_participants_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "corporate_participants_gift_box_id_fkey"
            columns: ["gift_box_id"]
            isOneToOne: false
      ...
      selections: {
        ...
        Relationships: [
          {
            foreignKeyName: "selections_gift_box_id_fkey"
            columns: ["gift_box_id"]
            isOneToOne: true
            referencedRelation: "gift_boxes"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "selections_selected_product_id_fkey"
    ...
    Enums: {
      ...
      event_type: "secret_santa" | "team_gift" | "birthday" | "other"
      gift_status: "pending" | "viewed" | "selected" | "cancelled"
    }
    CompositeTypes: {
      [_ in never]: never
    }
